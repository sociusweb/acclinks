    ...
    <div class="container">
      ...
      <div class="topbar">
        ...
        <div class="country" style="display:none;">
            <select class="country-select" onchange="changecountry(this.value)">
                ...
                <option value="2" selected>Kiribari</option>
            </select>
        </div>
        <script type="text/javascript">
            function changecountry(value){
                if (value==1) {
                    window.location ="<?php echo str_replace("/KI",'',base_url());?>";
                }else if (value == 2) {
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <?php
            if (isset($_SESSION['isUserLoggedin_ki']) && isset($_SESSION['name_ki']) && $_SESSION['isUserLoggedin_ki'])  {
              $name = explode(" ", $_SESSION['name_ki']);
              ?>
