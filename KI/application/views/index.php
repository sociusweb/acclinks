          ...
          <div id="collapseOne" class="panel-collapse collapse">
            <ul class="list-group">
              ...
              <li class="list-group-item" id="accordion11">
                ...
                <a href="#">Setup my handsets to use PacCell service:</a>
                <div id="collapseOneOne" class="panel-collapse collapse">
                  <br>
                  <ul class="list-unstyled">
                    <li>Our APN:“paccell”  SMSC:“+6748800300”</li>
                    <li>To setup our APN on a Android phone(Samsung, Huawei, ZTE, LG, HTC …).Setting -> Mobile Networks -> Access Point Names -> New then add APN name: 
                              paccell APN: paccell</li>
                    <li>To setup our APN on a iPhone (iPhone 5,5s,6,7,8,X) Settings -> Cellular -> Cellular Data Options -> Cellular Network OR Settings -> Mobile Data -> Mobile Data Options -> Mobile Data Network</li>
              ...
              <li class="list-group-item" id="accordion11">
                ...
                <a href="#">Understand current coverage of PacCell service</a>
              ...
              <li class="list-group-item" id="accordion11">
                ...
                <div id="collapseOneThree" class="panel-collapse collapse">
                  <br>
                  <ul class="list-unstyled">
                    <li>Please dial *88# and send to access our customer service menu.You may purchase PacCell topup card at any stores with board labled "PacCell Topup Here" in store front.</li>
                  </ul>
                </div>
              </li>
              <li class="list-group-item" id="accordion11">
                ...
                <div id="collapseOneFour" class="panel-collapse collapse">
                  <br>
                  <ul class="list-unstyled">
                    <li>Please dial our customer service number 100, Or you may visit our sales office located in Cenpac Yaren store to talk with our staff.</li>
              ...
              <li class="list-group-item" id="accordion11">
                ...
                <div id="collapseOneFive" class="panel-collapse collapse">
                  <br>
                  <ul class="list-unstyled">
                    <li>We thank you for your help report an issue. Your opinion is essential for us to provide better service. Please Click "Report an Issue" and fill the form. We will get back to you soon.Please mind that you are also encourage to call our customer service # 100 to report any issue or request service.</li>
                  </ul>
                </div>
              </li>
    ...
    <div class="row">
      <div class="col-md-4 boxs">
        ...
        <p style="text-align: justify;">To setup our APN on a Android phone
          ...
          Setting -> Mobile Networks -> Access...
          </p>
        <button class="btn btn-clr"><a href="<?php echo base_url();?>home/setup" style="color:white;">How to do it</a></button>
      </div>
      <div class="col-md-4 boxs">
        <h3>Contact Us</h3>
        <p>Customer service: 100 or 8803389<br>
            Email: tac@acclinks.com<br>
            Address: Cenpac Yaren Nauru</p>
        <button class="btn btn-clr"><a href="<?php echo base_url();?>home/support" style="color:white;">Feedback</a></button>
      </div>
      <div class="col-md-4 boxs">
        <h3>About Acclink Nauru</h3>
        <p>Acclinks Nauru Ltd. Inc. is a joint venture between Acclinks Communication Inc. and Nauru government. </p>
