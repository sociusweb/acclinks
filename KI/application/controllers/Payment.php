...
class Payment extends CI_Controller {
	...
	function pay(){
		$number = $this->session->flashdata('mobilenumber_ki');
		$amount = $this->session->flashdata('amount_ki');
		...
		$this->session->set_flashdata('out_trade_no_ki', $data['token']);
	...
	function alipay(){
		$trade_no = $this->session->flashdata('out_trade_no_ki');
		$amount = $this->session->flashdata('amount_ki');
