...
(function($) {
    ...
    $('.hidee:eq(1)').slideToggle();
    $('.hidee:eq(2)').slideToggle();
    $('.hidee:eq(3)').slideToggle();

    $('.accordion a.dropdown').click(function(j) {
        var dropDown = $(this).closest('li').find('.hidee');
        dropDown.removeClass('hide');
        $(this).closest('.accordion').find('.hidee').not(dropDown).slideUp();
