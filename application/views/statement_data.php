    ...
    <div class="row" style="margin:0px;">
     ...
     <div class="container-fluid">
          <div id="rates">
            <div class="bgtab">
                <div class="container">
                    <h2 style="text-align: center;">Data Statement</h2>
                                        ...
                                        <table id="datastatement" class="table table-hover table-condensed cf" id="table_flip">
                                           <thead>
                                            ...
                                            <tbody>
                                                  <?php
                                                       $i = 0;
                                                      foreach ($datadetails as $show) {
                                                      ?>
                                                <tr>
                                                    <td><?php echo$i=$i+1; ?></td>
                                                    <td><?php $date = new DateTime();
                                                        $date->setTimestamp(strtotime($show['BEGIN_TIME']));
                                                        echo $date->format('d/m/Y m:i'); ?></td>
                                                    <td><?php echo $show['CHARGED_NBR'];?></td>
                                                    <td><?php echo number_format($show['DURATION']/60, 2);?></td>
                                                     <td><?php echo number_format($show['TOTAL_FLUX']/1024, 2);?></td>
                                                     <td><?php $data = $show['FEE'];
                                                    list($first, $amt) = explode(":", $data);
                                                    echo $amt;
                                                    ?></td>
                ...
                <input type="hidden" id='mobnumber' value="<?php echo $_SESSION['mobnumber'] ?>">
                <input type="hidden" id='fname' value="<?php echo $_SESSION['name'] ?>">
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $('table').DataTable( {
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    autoFilter: true,
                    sheetName: 'Data Statement',
                    filename : 'DataStatement',
                 },{
                extend: 'pdfHtml5',
                messageTop: '',
                filename : 'DataStatement',
