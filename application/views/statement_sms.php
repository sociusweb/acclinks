  ...
  <div class="container-fluid">
          <div id="rates">
            <div class="bgtab">
                <div class="container">
                  <h2 style="text-align: center;">SMS Statement</h2>
                    <div class="print-tab" data-tab-id="1">
                        <ul class="print-tab-menu" style="display: none;" >
                            <li data-tab-menu="tab1"><a>Voice</a></li>
                            <li data-tab-menu="tab2"><a>SMS Usage</a></li>
                            <li data-tab-menu="tab3"><a>Data Usage</a></li>
                        </ul>
                                        ...
                                        <table class="table table-hover table-condensed cf" id="table_flip">
                                           <thead>
                                            ...
                                            <tbody>
                                                 <?php
                                                   $i = 0;
                                                  foreach ($smsdetails as $show) {
                                                  ?>
                                                <tr>
                                                    <td><?php echo$i=$i+1; ?></td>
                                                    <td><?php echo $show['BEGIN_TIME'];?></td>
                                                    <td><?php echo $show['CALLING_NBR'];?></td>
                                                    <td><?php echo $show['CALLED_NBR'];?></td>
        ...
        var Enddate = displayDate().getDate()+'-'+(displayDate().getMonth()+1)+'-'+displayDate().getFullYear();
         $('table').DataTable( {
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    autoFilter: true,
                    sheetName: 'SMS Statement',
                    filename : 'SmsStatement',
                 },{
                extend: 'pdfHtml5',
                messageTop: '',
                filename : 'SmsStatement',
