    ...
    <div class="row" style="margin:0px;">
     ...
     <div class="container-fluid">
          <div id="rates">
            <div class="bgtab">
                <div class="container">
                    <h2 style="text-align: center;">Recharge Statement</h2>
                                        ...
                                        <table id="datastatement" class="table table-hover table-condensed cf" id="table_flip">
                                           <thead>
                                            ...
                                            <tbody>
                                                  <?php
                                                       $i = 0;
                                                      foreach ($rechargedetails as $show) {
                                                    ?>
                                                <tr>
                                                    <td><?php echo$i=$i+1; ?></td>
                                                    <td><?php echo $show['PAYMENT_TYPE'];?></td>
                                                    <td><?php $date = new DateTime();
                                                        $date->setTimestamp(strtotime($show['PAYMENT_DATE']));
                                                        echo $date->format('d/m/Y m:i'); ?></td>
                                                    <td><?php echo $show['RESULT'];?></td>
                                                    <td><?php $data = ($show['AMOUNT']/100) ;
    ...
    <script type="text/javascript">
        ...
        $('table').DataTable( {
                ...
                buttons: [{
                    extend: 'excelHtml5',
                    autoFilter: true,
                    sheetName: 'Recharge Statement',
                    filename : 'RechargeStatement',
                 },{
                extend: 'pdfHtml5',
                messageTop: '',
                filename : 'RechargeStatement',
